          ...
          {userData && (
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-background border border-border rounded-lg shadow-lg z-50 animate-scale-in">
                    <div className="py-1">
                      <div className="px-4 py-3 border-b border-border">
                        <div className="text-sm font-medium text-foreground">{userData.displayName || userData.email}</div>
                        <div className="text-xs text-muted-foreground capitalize">{userData.role}</div>
                      </div>
